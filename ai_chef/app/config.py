...
STORAGE_BACKEND = os.getenv("AI_CHEF_STORAGE_BACKEND", "local").lower()
...
ALIYUN_OSS_SECURITY_TOKEN = os.getenv("ALIYUN_OSS_SECURITY_TOKEN", "")
ALIYUN_OSS_PUBLIC_BASE_URL = os.getenv("ALIYUN_OSS_PUBLIC_BASE_URL", "")
ALIYUN_OSS_OBJECT_PREFIX = os.getenv("ALIYUN_OSS_OBJECT_PREFIX", "ai-chef/uploads")
ALIYUN_OSS_ROLE_ARN = os.getenv("ALIYUN_OSS_ROLE_ARN", "")
ALIYUN_OSS_STS_ENDPOINT = os.getenv("ALIYUN_OSS_STS_ENDPOINT", "sts.aliyuncs.com")
ALIYUN_OSS_STS_DURATION_SECONDS = int(os.getenv("ALIYUN_OSS_STS_DURATION_SECONDS", "1800"))
